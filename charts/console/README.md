...
![Version: 0.7.15](https://img.shields.io/badge/Version-0.7.15-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.3.8](https://img.shields.io/badge/AppVersion-v2.3.8-informational?style=flat-square)
...
### [annotations](https://artifacthub.io/packages/helm/redpanda-data/redpanda?modal=values&path=annotations)
...
### [initContainers.extraInitContainers](https://artifacthub.io/packages/helm/redpanda-data/redpanda?modal=values&path=initContainers.extraInitContainers)
...
### [strategy](https://artifacthub.io/packages/helm/redpanda-data/redpanda?modal=values&path=strategy)
