...
![Version: 0.15.3](https://img.shields.io/badge/Version-0.15.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.3.6](https://img.shields.io/badge/AppVersion-v2.3.6-informational?style=flat-square)
...
### [deployment.extraEnvFrom](https://artifacthub.io/packages/helm/redpanda-data/redpanda?modal=values&path=deployment.extraEnvFrom)
