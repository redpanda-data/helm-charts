...
require (
	...
	github.com/redpanda-data/redpanda-operator/charts v0.0.0-20250108152555-7d0f73871aec
	github.com/redpanda-data/redpanda-operator/pkg v0.0.0-20250108152555-7d0f73871aec
